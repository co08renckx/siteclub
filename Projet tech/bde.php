  ...
  <div class="row " >
      ...
      <div class="col-9" >
        <div class="tab-content" id="v-pills-tabContent">
          <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
             <div class="row row-cols-1 row-cols-md-1">
              <?php
                ...
                $club = new Club("",0,"","","",0,0,"","","","");
                $clubs = $club->FindClubUntreatedBDE();
                $t = new Type(0,"");
                $s = new Specialite(0,"");
                $p = new Promotion(0,"");
          ...
          <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
             <div class="row row-cols-1 row-cols-md-1">
              <?php
                ...
                $events = $event->FindEventUntreatedBDE();
               $club = new Club("",0,"","","",0,0,"","","","");
              ...
              <div class="col col-md-auto" >
                <div class="card border border-primary rounded" style="width: auto;">
                  <div class="card-body" >
                    ...
                    <p class="card-text" style="margin-bottom:-2px;"><?php echo "<b>Date : </b>".$e['date_evenement']; ?></p>
                    <p class="card-text"style="margin-bottom:-2px;"><?php echo "<b>Heure de début : </b>".$e['Horaire_debut'].",<b> Heure de fin : </b>".$e['Horaire_fin']; ?></p>
          ...
          <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab" style="margin-left: 20px;"> 
             <div class="row row-cols-1 row-cols-md-1">
              <?php
                $event=new Evenement("","","",0,0,"","","","",0,"",0,0);
                $events = $event->FindEventtreatedBDE();
                $club = new Club("",0,"","","",0,0,"","","","");
                  ...
                  <div class="card-body" >
                    ...
                    <p class="card-text" >
                      <div class="form-check form-check-inline">
                        ...
                        <input class="btn btn-danger " type="submit" id ="supprimer_event"  value="Supprimer">
                      </form>
                      </div>
                    </p>
                  </div>
